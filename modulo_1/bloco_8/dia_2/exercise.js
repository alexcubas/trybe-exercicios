...
function authorBornIn1947() {
  ...
  const result = books.find((idade) => idade.author.birthYear === 1947)
...
function smallerName() {
  ...
  books.forEach((elemento) => {
    if (nameBook.length > elemento.name.length) {
...
function booksOrderedByReleaseYearDesc() {
  ...
  const result = books.sort((a, b) => b.releaseYear - a.releaseYear)
  // console.log(result)
  return result
}
