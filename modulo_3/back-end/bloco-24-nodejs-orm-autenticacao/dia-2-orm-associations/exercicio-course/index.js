...
app.get('/usersbooks/:id', async (req, res) => {
  try {
    ...
    //  Nota: a propriedade through: { attributes: [] } deve estar presente,
    //    pois sem ela, em cada book , apareceriam todos seus respectivos users . 
    //    fazê-lo sem e veja a diferença no resultado!
...
app.get('/booksusers/:id', async (req, res) => {
  try {
    const { id } = req.params;
